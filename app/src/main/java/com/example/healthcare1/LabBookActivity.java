    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db.addOrder(username,name.getText().toString(),address.getText().toString(),Integer.parseInt(pincode.getText().toString()),number.getText().toString(),date.toString(),time.toString(),Float.parseFloat(price[1].toString()),"lab");
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(LabBookActivity.this,CarddataActivity.class));
            }
        });
    }
}